...
class MilvusVectorClient(VectorClient):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._create_index(
            self.metric_type, self.index_type, self.index_field_name, self.nlist
        )
        self.vector_db.load()
    ...
    def _create_index(self, metric_type, index_type, field_name, nlist=100):
        ...
        index_params = {
            ...
            "params": {
                "nlist": nlist
            },  # Adjust the nlist parameter as per your requirements
        }
    ...
    def get_schema(self, embedding_size):
        ...
        fields = [
            ...
            FieldSchema(
                name="embedding", dtype=DataType.FLOAT_VECTOR, dim=embedding_size
            ),
            FieldSchema(name="metadata", dtype=DataType.JSON),
        ]

        schema = CollectionSchema(
            fields, "Collection for storing document embeddings and metadata"
        )
        return schema
